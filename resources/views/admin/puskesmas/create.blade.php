...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Tambah Data Puskesmas</h6>
                <form class="forms-sample" action="{{ route('puskesmas.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('departemen') is-invalid @enderror" id="input_departemen" name="departemen" value="{{ old('departemen') }}" placeholder="Departemen">
                        @error('departemen')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
